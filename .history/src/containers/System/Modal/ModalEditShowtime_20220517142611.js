...
class ModalEditShowtime extends Component {
    ...
    async componentDidMount() {
        ...
        this.setState({
            ...
            Showtime_type: showtime.showtime_type,
            vertical_size: showtime.vertical_size,
            horizontal_size: showtime.horizontal_size,
        });
    }
    ...
    handleUpdateShowtime = () => {
        ...
        if (valid === true) {
            this.props.handleUpdateShowtime(this.state);
        }
    ...
    render() {
        console.log(this.props.currentShowtime);
